...
<head>
    ...
    <!-- Incluye el archivo JavaScript para manejar eventos y lógica -->
...
<body>
    ...
    <div class="content">
        <!-- Muestra un enlace temporal para compartir archivos -->
        <h3>Sube tus archivos y comparte este enlace temporal: <span>ibu.pe/?nombre=<?php echo $carpetaNombre;?></span></h3>

        <!-- Verifica si no existe un archivo de contraseña en la carpeta -->
        <?php if (!file_exists($carpetaRuta . '/.password')): ?>
        <div class="password-form">
            <!-- Formulario para proteger la carpeta con contraseña -->
            <form method="POST">
                <label>
                    <input type="checkbox" id="habilitarPassword" onclick="togglePassword()"> Proteger con contraseña
                </label>
        ...
        <div class="container">
            ...
            <div class="drop-area" id="drop-area">
                <form action="" id="form" method="POST" enctype="multipart/form-data">
                    <!-- Ícono SVG para indicar la funcionalidad de arrastrar y soltar -->
            ...
            <div class="container2">
                <div id="file-list" class="pila">
                    <?php
                    // Escanea el directorio de destino para listar los archivos
                    $targetDir = $carpetaRuta;
                    $files = scandir($targetDir);
                    $files = array_diff($files, array('.', '..', '.password')); // Excluye archivos especiales

                    // Verifica si hay archivos en la carpeta
                    if (count($files) > 0) {
                        echo " <h3 style='margin-bottom:10px;'>Archivos Subidos:</h3>";

                        // Itera sobre los archivos y los muestra con opciones para descargar o eliminar
                        ...
                        // Muestra un mensaje si no hay archivos subidos
